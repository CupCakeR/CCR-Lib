...
function SQLStr(sqlStr)
	local escape = !CONNECTED_TO_MYSQL && sql.SQLStr || mysqlOO && function(str) return "\"" .. databaseObject:escape(tostring(str)) .. "\"" end || TMySQL && function(str) return "\"" .. databaseObject:Escape(tostring(str)) .. "\"" end
